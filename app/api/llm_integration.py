...
def generate_wellness_plan(user_data):
    ...
    try:
        ...
        from app.api.llm_prompt_path import get_llm_prompt_path
        prompt_path = get_llm_prompt_path()
        ...
        # Use the environment variable for output path if available
        output_dir = os.environ.get('GENERATED_DATA_PATH', 'generated_data')
        os.makedirs(output_dir, exist_ok=True)
        
        output_path = os.path.join(output_dir, f"wellness_plan_{user_name}_{timestamp}.md")
